...
import { handleTreeExpandAllCollapseAll } from './handleTreeExpandAllCollapseAll';
import { TreeNodeProps } from '../../ComponentProps/TreeNodeProps';

export default {
  title: 'Utils/handleTreeExpandAllCollapseAll',
  component: handleTreeExpandAllCollapseAll,
};
...
export const InteractiveTreeExpandCollapse = () => {
  ...
  const handleUpdateTree = () => {
    const updatedTree = handleTreeExpandAllCollapseAll(
      data,
      selectedKey,
      null,
      isExpanded
